    ...
    if gaussian_enabled:
        ...
        if rnn_enabled:
            ...
            if skill_enabled:
                ...
                elif algo_config.skill.finetune:
                    algo_class, algo_kwargs = BC_Transformer_SkillFinetune, {}
                else:
...
class BC_Transformer_SkillFinetune(BC):
    """
    BC training with a Transformer policy.
    """
    ...
    def _forward_training(self, batch, epoch=None):
        ...
        predictions["actions"] = self.projection(predictions["actions"])
